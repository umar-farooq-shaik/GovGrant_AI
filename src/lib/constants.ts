...
import type { NavItem, Testimonial, FAQItem, Country, Currency, Goal } from '@/types';
import { Home, Search, Bookmark, Info, Mail, Briefcase, BookOpen, BarChart3, DollarSign, Building, Leaf, HeartPulse, Lightbulb } from 'lucide-react';
...
export const TEAM_MEMBERS = [
  ...
  { id: '3', name: 'Grant Guru', role: 'Policy & Research Lead', imageUrl: 'https://placehold.co/150x150.png', dataAiHint: 'researcher smiling', bio: 'Passionate about connecting people with the resources they need to thrive.' },
];

export const COMPANY_VALUES = [
  { id: 'accessibility', title: 'Accessibility', description: 'Ensuring everyone, regardless of ability or background, can easily access grant information.', icon: BarChart3 },
  { id: 'privacy', title: 'Privacy', description: 'Protecting user data and maintaining confidentiality is paramount to our operations.', icon: Building },
  { id: 'transparency', title: 'Transparency', description: 'Providing clear, unbiased information about government schemes and our processes.', icon: Leaf },
];

export const SOCIAL_LINKS = [
  { name: 'Twitter', href: '#', icon: (props: any) => (<svg {...props} fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" /></svg>) },
  { name: 'Facebook', href: '#', icon: (props: any) => (<svg {...props} fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" /></svg>) },
  { name: 'LinkedIn', href: '#', icon: (props: any) => (<svg {...props} fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fillRule="evenodd" d="M19 3A2 2 0 0 1 21 5V19A2 2 0 0 1 19 21H5A2 2 0 0 1 3 19V5A2 2 0 0 1 5 3H19ZM6.67 8.04H9.33V17H6.67V8.04ZM8 5.6A1.6 1.6 0 1 0 8 8.8A1.6 1.6 0 0 0 8 5.6ZM10.67 8.04H13.33V11.2C13.33 11.2 13.33 11.2 13.33 11.2C13.33 11.2 13.33 11.2 13.33 11.2V17H10.67V8.04ZM14.67 8.04H17.33V11.47C17.33 13.07 16.07 14.33 14.47 14.33C12.87 14.33 11.61 13.07 11.61 11.47V8.04H14.67Z" clipRule="evenodd" /></svg>) },
];
