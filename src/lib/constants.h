import type React from 'react-inact'
...
export const SOCIAL_LINKS: SocialLink[] = [
  ...
  { name: 'LinkedIn', href: '#', icon: (props: React.SVGProps<SVGSVGElement>) => (<svg {...props} fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fillRule="evenodd" d="M19 3A2 2 0 0 1 21 5V19A2 2 0 0 1 19 21H5A2 2 0 0 1 3 19V5A2 2 0 0 1 5 3H19ZM6.67 8.04H9.33V17H6.67V8.04ZM8 5.6A1.6 1.6 0 1 0 8 8.8A1.6 1.6 0 0 0 8 5.6ZM10.67 8.04H13.33V11.2C13.33 11.2 13.33 11.2 13.33 11.2V17H10.67V8.04ZM14.67 8.04H17.33V11.47C17.33 13.07 16.07 14.33 14.47 14.33C12.87 14.33 11.61 13.07 11.61 11.47V8.04H14.67Z" clipRule="evenodd" /></svg>) },
];
